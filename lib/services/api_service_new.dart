...
class ApiService {
  ...
  Future<List<Map<String, dynamic>>> getHorariosDisponiveis(String profissionalId, String data) async {
    final cacheKey = _getCacheKey('getHorariosDisponiveis', {'profissionalId': profissionalId, 'data': data});
    ...
    debugPrint('🔍 [HORARIOS] Tentando /profissionais/$profissionalId/horarios-disponiveis?data=$data');
    final data_response = await _get('/profissionais/$profissionalId/horarios-disponiveis', queryParams: {'data': data});
    
    List<Map<String, dynamic>> horarios;
    if (data_response is List) {
      horarios = data_response.cast<Map<String, dynamic>>();
    } else if (data_response is Map && data_response.containsKey('horarios')) {
      horarios = (data_response['horarios'] as List).cast<Map<String, dynamic>>();
    } else {
      horarios = [];
    }
